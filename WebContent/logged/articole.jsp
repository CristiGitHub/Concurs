...
<div class="page-wrapper chiller-theme toggled">
 ...
 <main class="page-content pt-2">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="posts" role="tabpanel" aria-labelledby="posts-tab">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="messageStire" rows="3" placeholder="Aduga o Stire"></textarea>
                                </div>
                            ...
                            <div class="tab-pane fade" id="images" role="tabpanel" aria-labelledby="images-tab">
                                <div class="form-group">
                                    <div class="custom-file">
                                        <label class="sr-only" for="message">post</label>
                                         <textarea class="form-control" id="messageTitlu" rows="3" placeholder="Adauga un titltu"></textarea>
                                    </div>
                                </div>
                                <div class="py-4"></div>
                            </div>
  	...
  	<c:forEach items="${requestScope.allmes}" var="mes">	
 <div class="card gedf-card">
                    <div class="card-header">
                    ...
                    <div class="card-body">
                        ...
                        <a class="card-link" href="#">
                            <h5 class="card-title"><c:out value="${mes.getTitlu()}"></c:out></h5>
                        </a>

                        <p class="card-text">
                            
               
								<c:out value='${mes.getMesaj()}'>
